              ...
              <div class="row">
                <div class="signup-box">
                  ...
                  <form class="signup-form" action="/signup" method="POST">
                    ...
                    <div class="section">
                      <a class="btn btn-fb hide-on-small-only">${translate.message('signup.facebookSignin')}</a>
                      <a class="btn btn-fb hide-on-med-and-up">${translate.message('signup.call-to-action')} <i class="fa fa-facebook-official" aria-hidden="true"></i></a>
                    </div>
